...
def products_all_time():
    ...
    return [
        {"sku": "SKU-A", "product_name": "Alpha", "category": "Electronics",
         "total_revenue": 5000, "units_sold": 100},
        {"sku": "SKU-B", "product_name": "Beta",  "category": "Electronics",
         "total_revenue": 4000, "units_sold": 80},
        {"sku": "SKU-C", "product_name": "Gamma", "category": "Clothing",
         "total_revenue": 3000, "units_sold": 60},
        {"sku": "SKU-D", "product_name": "Delta", "category": "Clothing",
         "total_revenue": 2000, "units_sold": 40},
        {"sku": "SKU-E", "product_name": "Epsilon","category": "Food",
         "total_revenue": 1000, "units_sold": 20},
        {"sku": "SKU-F", "product_name": "Zeta",  "category": "Food",
         "total_revenue":  500, "units_sold": 10},
    ]
...
def products_with_tie():
    ...
    return [
        {"sku": "SKU-A", "product_name": "Alpha", "category": "Electronics",
         "total_revenue": 5000, "units_sold": 120},  # tie-winner (more units)
        {"sku": "SKU-B", "product_name": "Beta",  "category": "Electronics",
         "total_revenue": 5000, "units_sold": 80},   # tie-loser
        {"sku": "SKU-C", "product_name": "Gamma", "category": "Clothing",
         "total_revenue": 3000, "units_sold": 60},
        {"sku": "SKU-D", "product_name": "Delta", "category": "Clothing",
         "total_revenue": 2000, "units_sold": 40},
...
class TestTieBreaking:
    ...
    def test_tied_products_share_same_rank(self, products_with_tie):
        rows = [
            {"sku": "SKU-A", "product_name": "A", "category": "X",
             "total_revenue": 5000, "units_sold": 100},
            {"sku": "SKU-B", "product_name": "B", "category": "X",
             "total_revenue": 5000, "units_sold": 100},  # exact tie
            {"sku": "SKU-C", "product_name": "C", "category": "X",
             "total_revenue": 3000, "units_sold": 60},
        ]
