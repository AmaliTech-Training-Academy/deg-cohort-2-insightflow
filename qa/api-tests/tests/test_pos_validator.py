...
class TestValidatePosRow:
    ...
    def test_cashier_id_must_be_positive_integer(self):
        ...
        errors = validate_pos_row(row, row_num=2)
        assert any(e['field'] == 'cashier_id' and 'positive' in e['error'] for e in errors)
    ...
    def test_cashier_id_not_integer(self):
        ...
        errors = validate_pos_row(row, row_num=2)
        assert any(e['field'] == 'cashier_id' and 'Expected an integer' in e['error'] for e in errors)
    ...
    def test_unit_price_must_be_positive_decimal(self):
        ...
        errors = validate_pos_row(row, row_num=2)
        assert any(e['field'] == 'unit_price' and 'positive' in e['error'] for e in errors)
    ...
    def test_date_accepted_formats(self):
        ...
        for date_str in ['2024-06-01', '01/06/2024', '06/01/2024']:
            ...
            assert len(date_errors) == 0, f"Date format {date_str} failed: {date_errors}"
