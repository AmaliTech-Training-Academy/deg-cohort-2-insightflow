...
const mockSources: DataSource[] = [
  {
    ...
    name: "Store POS",
    type: "pos",
    lastSyncAt: new Date(NOW - 5 * 60_000).toISOString(), // 5 min ago
    status: "healthy",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    type: "online_orders",
    lastSyncAt: new Date(NOW - 2 * 3_600_000).toISOString(), // 2 hours ago
    status: "down",
  },
];
...
describe("SourceHealthTable", () => {
  ...
  it("renders status badges for all sources", () => {
    render(<SourceHealthTable sources={mockSources} />);
  ...
  it("renders an empty table body when no sources", () => {
