...
TAB3_CARDS = [
    {
        ...
        "display": "scalar",
        "sql": (
            'SELECT COALESCE(ROUND(SUM(revenue),2),0) AS "Total Revenue (RWF)"'
    ...
    },
    {
        ...
        "sql": (
            ...
            ' AS "Provinces" FROM v_regional_comparison;'
        ),
        "col": 8,
        "row": 0,
        "size_x": 8,
    ...
    },
    {
        ...
        "display": "scalar",
        "sql": (
            "SELECT COALESCE(region_name,'N/A') AS \"Top Province\""
    ...
    },
    {
        ...
        "display": "bar",
        "sql": (
            'SELECT region_name AS "Province",'
    ...
    {
        "name": "Satisfaction & NPS by Province",
        "display": "bar",
        "sql": (
            'SELECT region_name AS "Province",'
