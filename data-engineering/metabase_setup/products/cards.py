...
TAB2_CARDS = [
    {
        ...
        "sql": (
            ...
            ' AS "Units Sold" FROM v_product_revenue;'
        ),
        "col": 0,
        "row": 0,
        "size_x": 8,
    ...
    },
    {
        ...
        "display": "scalar",
        "sql": (
            'SELECT COUNT(DISTINCT product_name) AS "Products"'
    ...
    },
    {
        ...
        "sql": (
            ...
            ' AS "Categories" FROM v_product_revenue;'
        ),
        "col": 16,
        "row": 0,
        "size_x": 8,
    ...
    {
        "name": "Top 5 Products — All Time",
        "display": "table",
        "sql": (
            'SELECT revenue_rank AS "Rank", sku AS "SKU",'
    ...
    {
        "name": "Turnover Ratio by Category",
        "display": "bar",
        "sql": (
